...
- **Реализована односторонняя синхронизация базы данных из файла [google sheets](https://docs.google.com/spreadsheets/d/1HhPN8TKMyfb8Yy5dZ5S_reSsGHxike4Tv4P8VSz28o8/edit#gid=0). Данные из google sheets запрашиваются через Google API, парсятся, на их основе формируется датафрейм из которого в контейнере в папке admin создается актуальный файл Menu.xlsx, с которым уже ведется работа по синхронизации с БД. В данном случае bind mount не используется**
