...
> **Important**
> С момента запуска первого контейнера и до момента заполнения БД из Exel файла (или из Google sheets) может уходить окло 30 секунд.
