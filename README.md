...
Для комфортного использования приложения разработана система односторонней синхронизации Excel файла [Menu.xlsx](admin/Menu.xlsx) в папке /admin с базой данных путем обращения к API каждые 15 секунд в рамках фоновой задачи, запускаемой в Celery.
