...
- ***В соответствии с требованиями курса (доработки до 21:00 16.08.23) больше коммитов в ветку main не будет. Однако в ближайшее время в ветку [google_sheets_api](https://github.com/cyrillus31/YLab_Homework-1/tree/google_sheets_api) будет залит проект с поддержкой google sheets, в соответствии с одним из заданий со звездочкой из четвертого этапа. Готовность репозитория google_sheets_api к проверке (если преподаватель посчитает возможнным) будет видна из README этого репозитория***
