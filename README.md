...
## Endpoint `getall/`
Взвращает все меню, связанные с ними подменю и связанные с ними блюда одним запросом.
...
> **Important**
> Тесты на Postman  следует запускать на пустой БД, поэтому следует очистить [Excel таблицу администратора](admin/Menu.xlsx) и подождать ~15 секунд, чтобы база данных пришла в соответствие.
<br><br>
