...
Синхронизация с таблицей Google sheets является альтернативой опции выше и будет работать только при запуске через соответствующий Docker-compose файл. О командах для запуска разных версий API можно прочтить в одном из разделов ниже.
